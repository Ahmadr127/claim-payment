...
{{--
    ...
    - Dibuka via Alpine custom event: $dispatch('open-add-service-modal')
    - Setelah layanan dipilih: dispatch 'service-added' dengan payload service
    - Keyboard nav: ArrowUp/Down, Enter (pilih), Tab (next), Escape (tutup)
    - AJAX search ke: GET /diagnoses/services/search?q=...
--}}
<div
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Cari layanan dari database</p>
                    </div>
                </div>
