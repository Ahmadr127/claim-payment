            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-32">Kode Barang</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Obat / Alkes</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-40">Kategori</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-24">Satuan</th>
                        <th class="px-6 py-4 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider w-32">HNA Global</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-20">PPN Global</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($medications as $index => $med)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-900 font-semibold">{{ $med->name }}</td>
                            <td class="px-6 py-4 text-gray-700">{{ $med->medicationCategory->name ?? '-' }}</td>
                            <td class="px-6 py-4 text-center text-gray-500">{{ $med->unit }}</td>
                            <td class="px-6 py-4 text-right font-medium text-gray-900">
                                Rp {{ number_format($med->hna, 0, ',', '.') }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('unit-cost-medication-prices.edit', $med->id) }}" class="text-teal-600 hover:text-teal-900 font-medium inline-flex items-center gap-1.5 transition-colors" title="Kelola Tarif Unit Cost">
