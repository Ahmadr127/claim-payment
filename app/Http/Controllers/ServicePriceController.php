...
class ServicePriceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('service-prices.index', compact('services', 'search', 'groupId', 'groups'));
    }
    ...
    public function edit(MedicalService $service)
    {
        ...
        return view('service-prices.edit', compact('service', 'roomClasses', 'currentTariffs'));
    }
    ...
    public function update(Request $request, MedicalService $service)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('service-prices.index')->with('success', 'Tarif layanan medis berhasil diperbarui.');
        } catch (\Exception $e) {
            DB::rollBack();
